...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/DisasterStay-Emergency-Housing.git
...
git remote add origin https://github.com/yourusername/DisasterStay-Emergency-Housing.git
git branch -M main
